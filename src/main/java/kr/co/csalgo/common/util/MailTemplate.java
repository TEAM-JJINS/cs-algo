...
public class MailTemplate {
	...
	private static String headerSection() {
		String logoUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/logo.png";
		return """
	...
	private static String questionTitleSection(String questionTitle) {
		String questionIconUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/question.png";
		return """
				<tr><td style="padding:0 24px;">
					<img src="%s" width="20" style="vertical-align:middle; margin-right:6px;">
					<span style="font-size:22px; font-weight:bold;">%s</span>
				</td></tr>
			""".formatted(questionIconUrl, escapeHtml(questionTitle));
	}
	...
	private static String buttonSection(UUID userId) {
		String usageIconUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/usage.png";
		String unsubscriptionIconUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/cancel.png";
		return """
			...
			""".formatted(usageIconUrl, userId.toString(), unsubscriptionIconUrl);
	}
	...
	private static String feedbackUserAnswerSection(String username, String userAnswer) {
		String responseIconUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/response.png";
		return """
			...
			""".formatted(responseIconUrl, escapeHtml(username), escapeHtml(userAnswer));
	}

	private static String feedbackModelAnswerSection(String modelAnswer) {
		String solutionIconUrl = "https://csalgo-bucket.s3.ap-northeast-2.amazonaws.com/image/solution.png";
		return """
				<tr><td style="padding:32px 24px 0;">
					<img src="%s" width="20" style="vertical-align:middle; margin-right:6px;">
			...
			""".formatted(solutionIconUrl, escapeHtml(modelAnswer));
	}
